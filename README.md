...
# Usage:
```shell
Usage: mklinkfromlnk [-h] [-e] [-s] [-printerror] [-printstack [-printerror]] [-v [-s -printerror]] [-oledebug [-printstack -printerror]] [-vv [-v -printstack -oledebug]] [-c maximum-numbers-of-coroutines] [-r use-relative-path] [-d directory] [directory...]
e-path] [-d directory...]
...
The follow command create `symlink`, delete the `.lnk` file and skip all objects dirs `objects\..` of git repo
- mklinkfromlnk -e -skip "objects\\\\[0-9a-z]{2}$"
